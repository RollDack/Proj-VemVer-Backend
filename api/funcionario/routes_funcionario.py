...
@funcinario_blueprint.route('/funcionarios', methods=['GET']) 
...
@funcinario_blueprint.route('/funcionarios', methods=['POST']) 
...
@funcinario_blueprint.route('/funcionarios/<int:id_funcionario>', methods=['PUT'])
...
@funcinario_blueprint.route('/funcionarios/<int:id_funcionario>', methods=['DELETE'])
